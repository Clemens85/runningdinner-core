...
public class StandardTeamDistributionTest {
	...
	public void testTeamsWithoutDistributing() throws NoPossibleRunningDinnerException {
		...
		GeneratedTeamsResult teamsResult = runningDinnerCalculator.generateTeams(Configurations.standardConfigWithoutDistributing,
				teamMembers);
	...
	public void testNotAssignedTeamMembers() throws NoPossibleRunningDinnerException {
		...
		GeneratedTeamsResult result = runningDinnerCalculator.generateTeams(Configurations.standardConfig, teamMembers);
